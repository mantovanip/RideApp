...
allRides.forEach(async ([id, value]) => {
    ...
    const itemElemet = document.createElement("li")
    itemElemet.id = ride.id
    itemElemet.className = "d-flex p-1 align-items-center justify-content=between shadow-sm gap-3"
    rideListElement.appendChild(itemElemet)

    itemElemet.addEventListener("click", () => {
